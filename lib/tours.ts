...
export type Tour = {
  ...
  image: string
  details: string
  schedule?: TourSchedule // Added optional schedule configuration
}
...
const tours: Tour[] = [
  {
    ...
    shortDescription: "Glide across the bay as the sun dips below the horizon.",
    price: 129,
    durationHours: 2,
  ...
  },
  {
    ...
    shortDescription: "Discover hidden alleys, architecture, and stories of the old town.",
    price: 49,
    durationHours: 3,
  ...
  },
  {
    ...
    shortDescription: "A moderate ascent with panoramic views and expert guides.",
    price: 99,
    durationHours: 5,
  ...
  },
  {
    ...
    shortDescription: "Taste award-winning wines and stroll through vineyards.",
    price: 159,
    durationHours: 6,
  ...
  },
  {
    ...
    shortDescription: "Explore vibrant marine life with top-quality gear included.",
    price: 139,
    durationHours: 4,
  ...
  },
  {
    ...
    shortDescription: "Savor local flavors on a chef-curated tasting trail.",
    price: 69,
    durationHours: 2,
