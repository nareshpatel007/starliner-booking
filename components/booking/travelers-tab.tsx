    ...
    <Card className="bg-card shadow-soft border-border/50">
      <CardHeader className="space-y-2">
        ...
        <p className="text-sm text-muted-foreground leading-relaxed">
          Choose the number of adults, children, and infants. Maximum of 10 travelers allowed.
        </p>
      </CardHeader>
      <CardContent className="space-y-4">
        <div className="divide-y divide-border/50 rounded-xl border border-border/50 shadow-sm overflow-hidden">
          <div className="flex items-center justify-between px-5 py-4 bg-card hover:bg-muted/30 transition-smooth">
            ...
            <div className="flex items-center gap-4">
              <button
                ...
                className="h-10 w-10 rounded-full border-2 border-border hover:border-primary hover:bg-primary/10 transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary flex items-center justify-center"
              >
                <Minus className="h-4 w-4" />
              </button>
              <span className="w-10 text-center tabular-nums font-bold text-lg">{adults}</span>
              <button
                type="button"
                aria-label="Increase adults"
                onClick={() => setAdults(adults + 1)}
                className={cn(
                  "h-10 w-10 rounded-full border-2 border-border hover:border-primary hover:bg-primary/10 transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary flex items-center justify-center",
          ...
          <div className="flex items-center justify-between px-5 py-4 bg-card hover:bg-muted/30 transition-smooth">
            ...
            <div className="flex items-center gap-4">
              ...
              <span className="w-10 text-center tabular-nums font-bold text-lg">{children812}</span>
              <button
                type="button"
          ...
          <div className="flex items-center justify-between px-5 py-4 bg-card hover:bg-muted/30 transition-smooth">
            ...
            <div className="flex items-center gap-4">
              ...
              <span className="w-10 text-center tabular-nums font-bold text-lg">{children37}</span>
              <button
                type="button"
          ...
          <div className="flex items-center justify-between px-5 py-4 bg-card hover:bg-muted/30 transition-smooth">
            ...
            <div className="flex items-center gap-4">
              ...
              <span className="w-10 text-center tabular-nums font-bold text-lg">{infants}</span>
              <button
                type="button"
        ...
        <div className="flex items-center justify-between bg-primary/5 rounded-lg px-5 py-3 border border-primary/20">
          ...
          <span className="text-xl font-bold text-primary">{totalTravellers}</span>
        </div>
      </CardContent>
    </Card>
  )
