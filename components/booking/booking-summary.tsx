    ...
    return (
        <Card className="sticky top-24 h-fit overflow-hidden bg-card shadow-soft-lg pt-0 border-border/50">
            ...
            <CardHeader className="space-y-2">
                ...
                <p className="text-sm text-muted-foreground leading-relaxed">{tour.short_description}</p>
            </CardHeader>
            <CardContent className="space-y-3">
                ...
                {totalTravellers > 0 && (
                    <div className="flex items-center justify-between pt-4 border-primary/20">
                        <span className="text-base font-bold text-foreground">Payable Amount</span>
                        <span className="text-xl font-bold text-primary">{formatPrice(tour.price * totalTravellers)}</span>
                    </div>
                )}
            </CardContent>
        </Card>
