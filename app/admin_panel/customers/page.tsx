  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <Link href="/admin_panel/customers/create">
                  ...
                  filteredCustomers.map((customer) => (
                    ...
                    >
                      <td className="py-4 pr-4">
                        <span className="font-mono text-sm font-medium">{customer.id}</span>
                      </td>
                      <td className="py-4 pr-4">
                      ...
                      <td className="py-4 pr-4">
                        <div>
                          ...
                          <p className="text-xs text-muted-foreground">{customer.postalCode}</p>
                        </div>
                      </td>
                      <td className="py-4 pr-4">
